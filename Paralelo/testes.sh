...
for ((t=1; t<=2; t++)) do (time ./aco -t 6 scp41.txt) done > testes/41_16.txt 2>&1
...
for ((t=1; t<=2; t++)) do (time ./aco -t 6 scp55.txt) done > testes/55_16.txt 2>&1
...
for ((t=1; t<=2; t++)) do (time ./aco -t 6 scpd1.txt) done > testes/pd1_16.txt 2>&1
